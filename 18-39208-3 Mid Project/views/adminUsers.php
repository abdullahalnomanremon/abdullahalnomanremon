...
<!--Show Librarians--------------------------------------------------------------->
					<?php 
						$file = fopen('../model/userLibrarian.txt', 'r');
						while(!feof($file)){
							$user = fgets($file);
							if ($user!=null) {
								$userLibrarianArray = explode('|', $user);
					?>
					<tr>
						<td align="center"><?=$userLibrarianArray[0]?></td>
						<td align="center"><?=$userLibrarianArray[1]?></td>
						<td align="center"><?=$userLibrarianArray[2]?></td>
						<td align="center"><?=$userLibrarianArray[3]?></td>
						<td align="center">
							<a href="adminUserEdit.php?ut=librarian&un=<?=$userLibrarianArray[1]?>">Edit</a>
						</td>
						<td align="center">
							<a href="../controller/adminUserDelete.php?ut=librarian&un=<?=$userLibrarianArray[1]?>">Delete</a>
						</td>
					</tr>
					<?php
							} 
	...
	<table border="0" width="100%" height="50px">
		<tr>
			<td colspan="2" align="center">
				Copyright'2022' Web Technology, Section: G
			</td>
		</tr>
	</table>
